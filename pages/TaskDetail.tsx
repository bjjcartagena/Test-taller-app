...
const formatHistoryTitle = (taskTitle: string, record: any) => {
    if (record.subType) {
        if (taskTitle.toLowerCase().includes('filtros')) return `Cambio de Filtro: ${record.subType}`;
        return `Cambio: ${record.subType}`;
    }
                            ...
                            <div className="divide-y divide-gray-100 dark:divide-gray-800">
                                <div className="p-4 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors cursor-pointer group">
                                    <div className="flex justify-between items-start">
                                        ...
                                        <div className="flex items-center gap-1 bg-yellow-100 dark:bg-yellow-900/30 px-1.5 py-0.5 rounded text-xs font-bold text-yellow-700 dark:text-yellow-400">
                                            <span>4.9</span>
